...
long_description = 'some platform related functions, which also work correctly on wine'   # will be overwritten with long_description if exists !
...
setup_kwargs['description'] = 'some platform related functions, which also work correctly on wine'
...
setup_kwargs['entry_points'] = {'console_scripts': ['lib_platform = lib_platform.lib_platform_cli:cli_main']}
